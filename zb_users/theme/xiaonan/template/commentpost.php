<div class="commentpost" id="comment">
    <h4>{if $user.ID>0}{$user.Name#}{/if} 发表评论 <span><a rel="nofollow" id="cancel-reply" href="#comment" style="display:none;"><small>取消回复</small></a></span></h4>
...
{if $option['ZC_COMMENT_VERIFY_ENABLE']}
	<p><label for="inpVerify">验 证</label><input type="text" name="inpVerify" id="inpVerify" value="" size="28" tabindex="5" /><img src="{$article.ValidCodeUrl}" class="verifyimg" onclick="javascript:this.src='{$article.ValidCodeUrl}&amp;tm='+Math.random();" /> <font color="#ff6f3d">必填</font></p>
{/if}
