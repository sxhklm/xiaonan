<div class="commentpost" id="comment">
    <h4><?php if ($user->ID>0) { ?><?php  echo $user->Name#;  ?><?php } ?> 发表评论 <span><a rel="nofollow" id="cancel-reply" href="#comment" style="display:none;"><small>取消回复</small></a></span></h4>
...
<?php if ($option['ZC_COMMENT_VERIFY_ENABLE']) { ?>
	<p><label for="inpVerify">验 证</label><input type="text" name="inpVerify" id="inpVerify" value="" size="28" tabindex="5" /><img src="<?php  echo $article->ValidCodeUrl;  ?>" class="verifyimg" onclick="javascript:this.src='<?php  echo $article->ValidCodeUrl;  ?>&amp;tm='+Math.random();" /> <font color="#ff6f3d">必填</font></p>
<?php } ?>
